  ...
  : QSlider(parent)
{
  ...
  QString path = QDir::fromNativeSeparators("/home/trackingsetup/Documents/AnnotationTool/IconThemes/DarkIconTheme/128x128/actions/down.png");
  ...
  : QLabel(_parent)
{
  ...
  setAcceptDrops(true);
  //hard coded path to image :/ sorry
  QPixmap pix = QPixmap("/home/trackingsetup/Documents/AnnotationTool/IconThemes/DarkIconTheme/128x128/actions/down.png");
