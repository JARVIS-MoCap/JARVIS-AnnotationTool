...
QT.gui.disabled_features = opengles2 dynamicgl angle combined-angle-lib opengl openvg opengles3 opengles31 opengles32 system-textmarkdownreader texthtmlparser textodfwriter vulkan
QT_DEFAULT_QPA_PLUGIN = qxcb
QT_CONFIG += accessibility accessibility-atspi-bridge action clipboard colornames cssparser cursor desktopservices imageformat_xpm draganddrop freetype fontconfig gbm imageformatplugin harfbuzz highdpiscaling ico im image_heuristic_mask image_text imageformat_bmp imageformat_jpeg imageformat_png imageformat_ppm imageformat_xbm kms movie pdf picture sessionmanager shortcut standarditemmodel systemtrayicon tabletevent validator whatsthis wheelevent
QT_MODULES += gui
