...
QT.gui_private.enabled_features = xkbcommon xkbcommon-x11 xcb accessibility-atspi-bridge drm_atomic evdev freetype system-freetype fontconfig gif harfbuzz ico imageio-text-loading jpeg kms libinput libinput-axis-api linuxfb mtdev multiprocess png raster-64bit system-harfbuzz system-jpeg system-png vkgen vnc xlib xcb-xlib xcb-sm
