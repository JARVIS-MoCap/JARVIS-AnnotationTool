...
QT.network.enabled_features = dnslookup ftp http localserver networkinterface
QT.network.disabled_features = bearermanagement dtls gssapi networkdiskcache networkproxy opensslv11 ocsp schannel sctp securetransport socks5 ssl sspi udpsocket
QT_CONFIG += ftp getifaddrs http ipv6ifname localserver networkinterface
QT_MODULES += network
