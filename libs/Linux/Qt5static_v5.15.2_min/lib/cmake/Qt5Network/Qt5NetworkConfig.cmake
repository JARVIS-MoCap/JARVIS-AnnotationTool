...
if (NOT TARGET Qt5::Network)
    ...
    set_property(TARGET Qt5::Network PROPERTY INTERFACE_QT_ENABLED_FEATURES dnslookup;ftp;http;localserver;networkinterface)
    set_property(TARGET Qt5::Network PROPERTY INTERFACE_QT_DISABLED_FEATURES bearermanagement;dtls;gssapi;networkdiskcache;networkproxy;opensslv11;ocsp;schannel;sctp;securetransport;socks5;ssl;sspi;udpsocket)

    # Qt 6 forward compatible properties.
    set_property(TARGET Qt5::Network
                 PROPERTY QT_ENABLED_PUBLIC_FEATURES
                 dnslookup;ftp;http;localserver;networkinterface)
    set_property(TARGET Qt5::Network
                 PROPERTY QT_DISABLED_PUBLIC_FEATURES
                 bearermanagement;dtls;gssapi;networkdiskcache;networkproxy;opensslv11;ocsp;schannel;sctp;securetransport;socks5;ssl;sspi;udpsocket)
    set_property(TARGET Qt5::Network
                 PROPERTY QT_ENABLED_PRIVATE_FEATURES
                 linux-netlink;system-proxies)
    set_property(TARGET Qt5::Network
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 openssl-linked;openssl;libproxy;netlistmgr)
