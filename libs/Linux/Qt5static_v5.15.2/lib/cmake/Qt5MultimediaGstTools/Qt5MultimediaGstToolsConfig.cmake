...
set(Qt5MultimediaGstTools_VERSION_STRING 5.15.2)
...
function(_qt5_MultimediaGstTools_process_prl_file prl_file_location Configuration lib_deps link_flags)
    set(_lib_deps)
    set(_link_flags)

    set(_qt5_install_libs "${_qt5MultimediaGstTools_install_prefix}/lib/")
            ...
            elseif(_framework_flag OR _flag MATCHES "^-l(.*)$")
                ...
                elseif(_lib MATCHES "^pthread$")
                    ...
                    if(current_search_paths)
                        find_library(_Qt5MultimediaGstTools_${Configuration}_${_lib}_PATH ${_lib} HINTS ${current_search_paths} NO_DEFAULT_PATH)
                    endif()
                    find_library(_Qt5MultimediaGstTools_${Configuration}_${_lib}_PATH ${_lib} HINTS ${CMAKE_CXX_IMPLICIT_LINK_DIRECTORIES})
                    mark_as_advanced(_Qt5MultimediaGstTools_${Configuration}_${_lib}_PATH)
                    if(_Qt5MultimediaGstTools_${Configuration}_${_lib}_PATH)
                        list(APPEND _lib_deps
                            ${_Qt5MultimediaGstTools_${Configuration}_${_lib}_PATH}
                        )
                    else()
...
macro(_populate_MultimediaGstTools_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(_static_deps
        ${_Qt5MultimediaGstTools_STATIC_${Configuration}_LIB_DEPENDENCIES}
    )
    ...
    set(_static_link_flags "${_Qt5MultimediaGstTools_STATIC_${Configuration}_LINK_FLAGS}")
    if(_static_link_flags)
        set(_static_link_flags_genex "$<${_genex_condition}:${_static_link_flags}>")
        if(NOT CMAKE_VERSION VERSION_LESS "3.13")
            set_property(TARGET Qt5::MultimediaGstTools APPEND PROPERTY INTERFACE_LINK_OPTIONS
...
if (NOT TARGET Qt5::MultimediaGstTools)
    ...
    set(Qt5MultimediaGstTools_PRIVATE_INCLUDE_DIRS
        "${_qt5MultimediaGstTools_install_prefix}/include/QtMultimediaGstTools/5.15.2"
        "${_qt5MultimediaGstTools_install_prefix}/include/QtMultimediaGstTools/5.15.2/QtMultimediaGstTools"
    )
    ...
    foreach(_module_dep ${_Qt5MultimediaGstTools_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5MultimediaGstTools_FIND_VERSION_EXACT}
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_MultimediaGstTools_process_prl_file(
            "${_qt5MultimediaGstTools_install_prefix}/lib/libQt5MultimediaGstTools.prl" RELEASE
            _Qt5MultimediaGstTools_STATIC_RELEASE_LIB_DEPENDENCIES
            _Qt5MultimediaGstTools_STATIC_RELEASE_LINK_FLAGS
        )
    endif()

    add_library(Qt5::MultimediaGstTools STATIC IMPORTED)
    set_property(TARGET Qt5::MultimediaGstTools PROPERTY IMPORTED_LINK_INTERFACE_LANGUAGES CXX)
    ...
    _populate_MultimediaGstTools_target_properties(RELEASE "libQt5MultimediaGstTools.a" "" FALSE)
