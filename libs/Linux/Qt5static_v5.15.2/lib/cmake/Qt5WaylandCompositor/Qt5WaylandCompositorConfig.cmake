...
set(Qt5WaylandCompositor_VERSION_STRING 5.15.2)
...
if (NOT TARGET Qt5::WaylandCompositor)
    ...
    set(Qt5WaylandCompositor_PRIVATE_INCLUDE_DIRS
        "${_qt5WaylandCompositor_install_prefix}/include/QtWaylandCompositor/5.15.2"
        "${_qt5WaylandCompositor_install_prefix}/include/QtWaylandCompositor/5.15.2/QtWaylandCompositor"
    )
    ...
    foreach(_module_dep ${_Qt5WaylandCompositor_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5WaylandCompositor_FIND_VERSION_EXACT}
    ...
    set_property(TARGET Qt5::WaylandCompositor
                 ...
                 wayland-server;wayland-datadevice;wayland-dmabuf-client-buffer;wayland-dmabuf-server-buffer;wayland-drm-egl-server-buffer;wayland-egl;wayland-shm-emulation-server-buffer;xcomposite-egl;xcomposite-glx)
    set_property(TARGET Qt5::WaylandCompositor
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 wayland-brcm;wayland-layer-integration-vsp2;wayland-libhybris-egl-server-buffer;wayland-vulkan-server-buffer)
