...
_qt5_Sql_process_prl_file(
    "${_qt5Sql_install_prefix}/plugins/sqldrivers/libqsqlmysql.prl" RELEASE
    _Qt5QMYSQLDriverPlugin_STATIC_RELEASE_LIB_DEPENDENCIES
    _Qt5QMYSQLDriverPlugin_STATIC_RELEASE_LINK_FLAGS
)


set_property(TARGET Qt5::QMYSQLDriverPlugin PROPERTY INTERFACE_SOURCES
    "${CMAKE_CURRENT_LIST_DIR}/Qt5Sql_QMYSQLDriverPlugin_Import.cpp"
)

_populate_Sql_plugin_properties(QMYSQLDriverPlugin RELEASE "sqldrivers/libqsqlmysql.a" FALSE)
...
set(_user_specified_genex
    "$<IN_LIST:Qt5::QMYSQLDriverPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
set(_user_specified_genex_versionless
    "$<IN_LIST:Qt::QMYSQLDriverPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
    ...
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                ...
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QMYSQLDriverPlugin,QT_PLUGIN_EXTENDS>,Qt::Sql>,"
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QMYSQLDriverPlugin,QT_PLUGIN_EXTENDS>,>"
            ">,"
            "$<NOT:$<IN_LIST:Qt5::QMYSQLDriverPlugin,${_no_plugins_genex}>>,"
            "$<NOT:$<IN_LIST:Qt::QMYSQLDriverPlugin,${_no_plugins_genex}>>"
        ">"
...
set_property(TARGET Qt5::QMYSQLDriverPlugin APPEND PROPERTY INTERFACE_LINK_LIBRARIES
