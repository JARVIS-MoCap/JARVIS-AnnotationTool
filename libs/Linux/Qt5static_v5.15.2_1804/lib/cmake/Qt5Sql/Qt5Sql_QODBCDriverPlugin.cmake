...
_qt5_Sql_process_prl_file(
    "${_qt5Sql_install_prefix}/plugins/sqldrivers/libqsqlodbc.prl" RELEASE
...
set(_user_specified_genex_versionless
    "$<IN_LIST:Qt::QODBCDriverPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
    ...
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                ...
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QODBCDriverPlugin,QT_PLUGIN_EXTENDS>,Qt::Sql>,"
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QODBCDriverPlugin,QT_PLUGIN_EXTENDS>,>"
            ">,"
            "$<NOT:$<IN_LIST:Qt5::QODBCDriverPlugin,${_no_plugins_genex}>>,"
            "$<NOT:$<IN_LIST:Qt::QODBCDriverPlugin,${_no_plugins_genex}>>"
        ">"
