...
QT.gui_private.enabled_features = xkbcommon xkbcommon-x11 xcb accessibility-atspi-bridge drm_atomic evdev freetype system-freetype fontconfig gif harfbuzz ico imageio-text-loading jpeg kms libinput libinput-axis-api linuxfb mtdev multiprocess png raster-64bit system-harfbuzz system-jpeg system-png system-xcb-xinput tuiotouch vkgen vnc xlib xcb-xlib xcb-sm
...
QMAKE_LIBS_LIBJPEG = -L/build/libjpeg-turbo-6HlDLQ/libjpeg-turbo-2.0.3/obj-x86_64-linux-gnu/lib/x86_64-linux-gnu -ljpeg
