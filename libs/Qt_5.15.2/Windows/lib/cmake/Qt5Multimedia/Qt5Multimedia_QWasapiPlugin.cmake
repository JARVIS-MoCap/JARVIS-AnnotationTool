...
set(_user_specified_genex_versionless
    "$<IN_LIST:Qt::QWasapiPlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
    ...
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                ...
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QWasapiPlugin,QT_PLUGIN_EXTENDS>,Qt::Multimedia>,"
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::QWasapiPlugin,QT_PLUGIN_EXTENDS>,>"
            ">,"
            "$<NOT:$<IN_LIST:Qt5::QWasapiPlugin,${_no_plugins_genex}>>,"
            "$<NOT:$<IN_LIST:Qt::QWasapiPlugin,${_no_plugins_genex}>>"
        ">"
    ">:Qt5::QWasapiPlugin>"
)
