...
set(_user_specified_genex_versionless
    "$<IN_LIST:Qt::DSServicePlugin,${_manual_plugins_genex};${_plugin_type_genex}>"
)
    ...
    "$<$<OR:"
        ...
        "$<AND:"
            ...
            "$<OR:"
                ...
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::DSServicePlugin,QT_PLUGIN_EXTENDS>,Qt::Multimedia>,"
                "$<STREQUAL:$<TARGET_PROPERTY:Qt5::DSServicePlugin,QT_PLUGIN_EXTENDS>,>"
            ">,"
            "$<NOT:$<IN_LIST:Qt5::DSServicePlugin,${_no_plugins_genex}>>,"
            "$<NOT:$<IN_LIST:Qt::DSServicePlugin,${_no_plugins_genex}>>"
        ">"
    ">:Qt5::DSServicePlugin>"
)
